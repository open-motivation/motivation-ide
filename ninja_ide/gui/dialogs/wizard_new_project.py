...
class WizardNewProject(QWizard):
    ...
    def __init__(self, parent):
        ...
        self.setWindowTitle(self.tr("Motivation - New Project Wizard"))
...
class PythonProjectHandler(plugin_interfaces.IProjectTypeHandler):
    ...
    def on_wizard_finish(self, wizard):
        """
        Create the Motivation Project (.mtvtn file), create the main __init__.py
...
class ImportFromSourcesProjectHandler(plugin_interfaces.IProjectTypeHandler):
    ...
    def on_wizard_finish(self, wizard):
        """
        Create the Motivation Project (.mtvtn file) and open the project
        """
        ids = wizard.pageIds()
        page = wizard.page(ids[1])
        name = page.txtName.text()

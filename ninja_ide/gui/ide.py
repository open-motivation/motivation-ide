...
###############################################################################
    ...
    def __init__(self, start_server=False):
        ...
        self.setWindowTitle('MOTIVATION-IDE')
    ...
    def __set_profile(self, profileName):
        ...
        if self.profile is not None:
            self.setWindowTitle('MOTIVATION-IDE (PROFILE: %s)' % self.profile)
        else:
            self.setWindowTitle(
                'MOTIVATION-IDE')
    ...
    def change_window_title(self, title):
        if self.profile is None:
            self.setWindowTitle('MOTIVATION-IDE - %s' % title)
        else:
            self.setWindowTitle('MOTIVATION-IDE (PROFILE: %s) - %s' % (
                self.profile, title))

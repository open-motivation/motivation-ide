...
Rectangle {
    ...
    Rectangle {
        ...
        Text {
            ...
            anchors.topMargin: 10
            text: "MOTIVATION-IDE, is a Linux X/11 integrated development environment specially designed to build Python Applications. MOTIVATION-IDE provides tools to simplify the Python-software development and handles all kinds of situations thanks to its rich extensibility."
        ...
        Column {
            ...
            Row {
                ...
                Button {
                    ...
                    height: 35
                    text: "Visit us!"
                    onClicked: Qt.openUrlExternally("http://motivation.ga/")
                }
                Button {
                    width: colButtons.buttonWidth
                    height: 35
    ...
    Text {
        ...
        color: "black"
        text: "Copyright © 2014 Motivation Software under GPLv3 License agreements"
    }
